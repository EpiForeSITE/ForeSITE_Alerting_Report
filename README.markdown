...
- [ForeSITE Alerting Report](#foresite-alerting-report)
  * [✨ Features](#--features)
    ...
    + [🎨 User-Friendly Customization](#---user-friendly-customization)
    + [⚙️ Backend Processing](#---backend-processing)
  * [✨ Changelog](#--changelog)
  ...
  * [Installation From Source Code](#installation-from-source-code)
    ...
    + [2. Set Up the WPF Application](#2-set-up-the-wpf-application)
    + [3. Set Up the epySurv environment (optional)](#3-set-up-the-epysurv-environment--optional-)
    + [4. Set Up the Flask Server (optional)](#4-set-up-the-flask-server--optional-)
    + [5. Run the Application](#5-run-the-application)
  * [Installation From Release Version](#installation-from-release-version)
    ...
    + [🔹 5. Create a Report](#---5-create-a-report)
    + [🔹 6. Save Report Template](#---6-save-report-template)
    + [🔹 7. Schedule Automated Reports](#---7-schedule-automated-reports)
    + [🔹 8. Output](#---8-output)
    + [⚠️ Notes / Tips](#---notes---tips)
  * [Usage](#usage)
    + [Creating a Report](#creating-a-report)
    + [Importing Custom Data](#importing-custom-data)
    + [Managing Data Sources](#managing-data-sources)
    + [Scheduling Automated Reports](#scheduling-automated-reports)
  * [Flask Server](#flask-server)
    + [Example Flask Setup](#example-flask-setup)
  * [Project Structure](#project-structure)
  * [Dependencies](#dependencies)
  * [Animation Demo](#animation-demo)
  * [Scheduler Start Screen](#scheduler-start-screen)
    + [Advanced Data Analysis with Notebook](#advanced-data-analysis-with-notebook)
    + [Import customized data set](#import-customized-data-set)
